...
*Triggered By:* [link](https://github.com/vtjnash/julia/commit/d753a0b6a78d94d08c17b2c227916700e3359e4a#commitcomment-47437605)
...
```
NanosoldierError: failed to run benchmarks against primary commit: failed process: Process(`/home/ubuntu/julia-1.5.3/bin/julia --project=/home/ubuntu/test_workdir/jl_U1mEHA/environment --startup-file=no -e '
...
Stacktrace:
 ...
 [4] execute_benchmarks!(::Nanosoldier.BenchmarkJob, ::Symbol) at /home/ubuntu/Nanosoldier.jl/src/jobs/BenchmarkJob.jl:298
