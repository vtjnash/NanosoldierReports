...
*Triggered By:* [link](https://github.com/vtjnash/julia/commit/d753a0b6a78d94d08c17b2c227916700e3359e4a#commitcomment-47433936)
...
```
NanosoldierError: failed to run benchmarks against primary commit: failed process: Process(`/home/vtjnash/test_workdir/jl_Dh9giE/julia -e 'VERSION >= v"0.7.0-DEV.3656" && using Pkg; Pkg.update()'`, ProcessExited(1)) [1]

Stacktrace:
 [1] pipeline_error at ./process.jl:525 [inlined]
 [2] run(::Cmd; wait::Bool) at ./process.jl:440
 [3] run at ./process.jl:438 [inlined]
 [4] execute_benchmarks!(::Nanosoldier.BenchmarkJob, ::Symbol) at /data/nanosoldierbot/Nanosoldier.jl/src/jobs/BenchmarkJob.jl:273
 [5] run(::Nanosoldier.BenchmarkJob) at /data/nanosoldierbot/Nanosoldier.jl/src/jobs/BenchmarkJob.jl:202
